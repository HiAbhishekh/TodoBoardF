...
//   style={{ cursor: 'move',  }} // Increased minWidth
// >
//   <div className="flex flex-col flex-grow">
//     <span className="text-xs text-gray-500">
//       {formatDate(item.createdTime || item.created_time)}
//     </span>
//     <span className="font-semibold text-lg">{item.title}</span> {/* Increased font size */}
//   </div>
  
//   {/* Item Owner */}
//   <div className="flex flex-col items-end">
//     <span className="mr-2">{item.owner}</span> {/* Owner text */}
//     <button
//       className="text-red-500 hover:text-red-700"
...
//           <nav className="flex-1 overflow-y-auto">
//           {boards
//     .slice() // Create a shallow copy of the boards array to avoid mutating the original state
//     .sort((a, b) => (a.title === 'MyBoard' ? -1 : b.title === 'MyBoard' ? 1 : 0)) // Sort "MyBoard" to the top
//     .map((board) => (
//             <button
//             key={board.id}
//             onClick={() => handleBoardClick(board.id)} // Call the updated function here
